      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="mb-5">
            ...
            <span >${donations.description}</span>
          </div>

          <div class="pt-5">
            <h4 class="mb-5" > Danh sách quyên góp</h4>
           <h3 class="mb-5"> ${donations.name} </h3>
              ...
              <th>
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3></h3>
                    <div class="meta" style="color: #373b3e !important;" ><c:out value= "${donations.created}" /></div>
                    <p></p>
                  </div>
                </li>
              </th>
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              <li class="mb-2"><strong class="text-black">Mã đợt quyên góp:</strong> ${donations.code} </li>
              <li class="mb-2"><strong class="text-black">Tên đợt quyên góp:</strong> ${donations.name} </li>
              <li class="mb-2"><strong class="text-black">Ngày bắt đầu:</strong> ${donations.startDate} </li>
              <li class="mb-2"><strong class="text-black">Ngày kết thúc:</strong> ${donations.end_date} </li>
              <li class="mb-2"><strong class="text-black">Cá nhân/Tổ chức:</strong> ${donations.organizationName}</li>
              <li class="mb-2"><strong class="text-black">Số điện thoại: </strong> ${donations.phoneNumber}</li>
              <li class="mb-2"><strong class="text-black">Tổng tiền quyên góp nhận được:</strong> ${donations.money}</li>
